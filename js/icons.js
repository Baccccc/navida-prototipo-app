...
window.NAVIDA_ICONS = {
  ...
  /* --- elenco a icone delle schermate di racconto ------------------ */
  ...
  'eye-off':       '<path d="M10.7 5.1a10.7 10.7 0 0 1 11.2 6.6 1 1 0 0 1 0 .7 10.7 10.7 0 0 1-1.4 2.5"/>' +
                   '<path d="M14.1 14.2a3 3 0 0 1-4.3-4.3"/>' +
                   '<path d="M17.5 17.5A10.8 10.8 0 0 1 2.1 12.3a1 1 0 0 1 0-.7 10.8 10.8 0 0 1 4.4-5.1"/>' +
                   '<path d="m2 2 20 20"/>',
